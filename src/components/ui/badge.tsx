...
const badgeVariants = cva(
  "inline-flex items-center rounded-full border px-3 py-1 text-xs font-bold transition-all duration-200 focus:outline-none focus:ring-2 focus:ring-ring focus:ring-offset-2 shadow-sm hover:shadow-md",
  {
    variants: {
      variant: {
        default:
          "border-transparent bg-gradient-primary text-white hover:opacity-90 hover:scale-105",
        secondary:
          "border-transparent bg-gradient-secondary text-white hover:opacity-90 hover:scale-105",
        destructive:
